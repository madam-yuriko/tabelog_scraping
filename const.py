...
DATA_FLAME_LAYOUT = {
    ...
    '口コミ数': [80, tk.E], '口コミ数(増減)': [80, tk.E], '保存件数': [90, tk.E], '予算(夜)': [150, tk.E], '予算(昼)': [150, tk.E], 
...
MERGE_COL_NAMES = [
    ...
    'アカウント', '予算', 'ステータス(昨年)', '点数(昨年)', '口コミ数(昨年)', '_merge'
]
...
SHISETSU_DICT = {
    ...
    '札幌 狸COMICHI': {'都道府県': '北海道', '場所1': '札幌', '場所2': '中央区南2条西2-5', '場所3': ''},
    '新千歳空港': {'都道府県': '北海道', '場所1': '新千歳空港', '場所2': '', '場所3': ''},
    '新宿高島屋タイムズスクエア': {'都道府県': '東京都', '場所1': '渋谷区千駄ヶ谷5-24-2', '場所2': '13F|14F', '場所3': ''},
    '新宿 NEWoMan新宿': {'都道府県': '東京都', '場所1': '渋谷区千駄ヶ谷5-24-55', '場所2': '', '場所3': ''},
    ...
    '赤坂 東京ミッドタウン': {'都道府県': '東京都', '場所1': '赤坂9-7-1|赤坂9-7-2|赤坂9-7-3|赤坂9-7-4', '場所2': '', '場所3': ''},
    ...
    '丸の内ブリックスクエア': {'都道府県': '東京都', '場所1': '丸の内2-6-1|丸の内ブリックスクエア', '場所2': '', '場所3': ''},
    '八重洲地下街': {'都道府県': '東京都', '場所1': '八重洲地下街', '場所2': '', '場所3': ''},
    '八重洲 東京ミッドタウン八重洲': {'都道府県': '東京都', '場所1': '八重洲2-2-1', '場所2': '', '場所3': ''},
    '羽田空港': {'都道府県': '東京都', '場所1': '大田区', '場所2': '羽田空港', '場所3': ''},
    ...
    '亀戸 カメイドクロック': {'都道府県': '東京都', '場所1': '亀戸6-31-6', '場所2': '', '場所3': ''},
    '南砂町SUNAMO': {'都道府県': '東京都', '場所1': '江東区新砂3-4-31', '場所2': '', '場所3': ''},
    'コクーンシティ': {'都道府県': '埼玉県', '場所1': 'コクーン', '場所2': 'さいたま新都心', '場所3': ''},
    '東京ディズニーランド': {'都道府県': '千葉県', '場所1': 'ディズニーランド', '場所2': '', '場所3': ''},
    '東京ディズニーシー': {'都道府県': '千葉県', '場所1': 'ディズニーシー', '場所2': '', '場所3': ''},
