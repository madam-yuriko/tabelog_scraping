...
# DataFrameレイアウト
DATA_FLAME_LAYOUT = {
    'No': [40, tk.E], '全国順位': [60, tk.E], '順位変動': [70, tk.E], '店名': [300, tk.W], 'ステータス': [80, tk.W], '点数': [60, tk.E], '点数(増減)': [60, tk.E], 
...
MERGE_COL_NAMES = [
    ...
    '口コミ数(昨年)', '保存件数(昨年)', '全国順位(昨年)', '_merge'
]

# 商業施設一覧
SHISETSU_DICT = {
    '': {},
    '北海道 札幌ステラプレイス': {'都道府県': '北海道', '場所1': 'ステラプレイス', '場所2': '', '場所3': ''},
    '北海道 PASEO': {'都道府県': '北海道', '場所1': '札幌', '場所2': 'パセオ|PASEO', '場所3': ''},
    '北海道 札幌エスタ': {'都道府県': '北海道', '場所1': '札幌市中央区北', '場所2': 'エスタ|ESTA', '場所3': ''},
    '北海道 大丸札幌店': {'都道府県': '北海道', '場所1': '大丸札幌', '場所2': '8F', '場所3': ''},
    '北海道 サッポロファクトリー': {'都道府県': '北海道', '場所1': 'サッポロファクトリー', '場所2': '', '場所3': ''},
    '北海道 札幌PARCO': {'都道府県': '北海道', '場所1': '南1条西3-3|南1条西3丁目3', '場所2': '', '場所3': ''},
    '北海道 日本生命 noasis': {'都道府県': '北海道', '場所1': '札幌', '場所2': '日本生命', '場所3': ''},
    '北海道 赤れんがテラス': {'都道府県': '北海道', '場所1': '札幌', '場所2': '赤れんが|赤レンガ', '場所3': ''},
    ...
    '北海道 狸COMICHI': {'都道府県': '北海道', '場所1': '札幌', '場所2': '中央区南2条西2-5', '場所3': ''},
    '北海道 新千歳空港': {'都道府県': '北海道', '場所1': '新千歳空港', '場所2': '', '場所3': ''},
    '千代田区 東京交通会館': {'都道府県': '東京都', '場所1': '丸の内1-9-1|丸ノ内1-9-1', '場所2': '', '場所3': ''},
    '千代田区 東京駅': {'都道府県': '東京都', '場所1': '有楽町2-10-1|交通会館', '場所2': '', '場所3': ''},
    ...
    '渋谷区 ヒカリエ': {'都道府県': '東京都', '場所1': '渋谷2-21-1|渋谷ヒカリエ', '場所2': '', '場所3': ''},
    '渋谷区 ストリーム': {'都道府県': '東京都', '場所1': '渋谷3-21-3|渋谷ストリーム', '場所2': '', '場所3': ''},
    '渋谷区 スクランブルスクエア': {'都道府県': '東京都', '場所1': '渋谷2-24-12|渋谷スクランブルスクエア', '場所2': '', '場所3': ''},
    '渋谷区 パルコ': {'都道府県': '東京都', '場所1': '宇田川町15-1|渋谷PARCO|渋谷パルコ', '場所2': '', '場所3': ''},
    '渋谷区 フクラス': {'都道府県': '東京都', '場所1': '道玄坂1-2-3|東急プラザ渋谷|渋谷フクラス', '場所2': '', '場所3': ''},
    ...
    '葛飾区 アリオ亀有': {'都道府県': '東京都', '場所1': '亀有3-49-3', '場所2': '', '場所3': ''},
