...
DATA_BASE = 'data_base_all_2022.csv'
...
# DataFrameレイアウト
DATA_FLAME_LAYOUT = {
    'No': [50, tk.E], '全国順位': [70, tk.E], '店名': [300, tk.W], 'ステータス': [80, tk.W], '点数': [80, tk.E], '口コミ数': [80, tk.E], '保存件数': [80, tk.E],
...
SHISETSU_DICT = {
    '': {},
    '札幌ステラプレイス': {'場所1': 'ステラプレイス', '場所2': '', '場所3': ''},
    '札幌 PASEO': {'場所1': '札幌', '場所2': 'パセオ|PASEO', '場所3': ''},
    '札幌エスタ': {'場所1': '札幌市中央区北', '場所2': 'エスタ|ESTA', '場所3': ''},
    '札幌 サッポロファクトリー': {'場所1': 'サッポロファクトリー', '場所2': '', '場所3': ''},
    '札幌 日本生命 noasis': {'場所1': '札幌', '場所2': '日本生命', '場所3': ''},
    '札幌 赤れんがテラス': {'場所1': '札幌', '場所2': '赤れんが|赤レンガ', '場所3': ''},
    '札幌 sitatte sapporo': {'場所1': '札幌', '場所2': 'sitatte|フコク生命', '場所3': ''},
    '札幌 大通BISSE': {'場所1': '中央区大通西3', '場所2': '', '場所3': ''},
    '札幌 miredo': {'場所1': '札幌', '場所2': '大同生命', '場所3': ''},
    '熊本 サクラマチクマモト': {'場所1': '桜町3-10', '場所2': '', '場所3': ''},
    '渋谷ヒカリエ': {'場所1': '渋谷2-21-1', '場所2': '', '場所3': ''},
    '渋谷ストリーム': {'場所1': '渋谷3-21-3', '場所2': '', '場所3': ''},
    '渋谷スクランブルスクエア': {'場所1': '渋谷2-24-12', '場所2': '12F|13F', '場所3': ''},
    '渋谷パルコ': {'場所1': '宇田川町15-1', '場所2': '', '場所3': ''},
    '渋谷フクラス': {'場所1': '道玄坂1-2-3', '場所2': '', '場所3': ''},
    '渋谷 ミヤシタパーク': {'場所1': '神宮前', '場所2': '6-20-10|六丁目20-10', '場所3': ''},
    '渋谷6種商業施設': {'場所1': '渋谷2-21-1|渋谷3-21-3|渋谷2-24-12|宇田川町15-1|道玄坂1-2-3|神宮前6-20-10', '場所2': '', '場所3': ''},
    '原宿 WITH HARAJUKU': {'場所1': '神宮前1-14-30', '場所2': '', '場所3': ''},
    '原宿 神宮前COMICHI': {'場所1': '神宮前1-23-26', '場所2': '', '場所3': ''},
    '恵比寿 アトレ恵比寿': {'場所1': 'アトレ恵比寿', '場所2': '5F|6F', '場所3': ''},
    '池袋 東武百貨店 スパイス': {'場所1': '池袋', '場所2': '東武百貨店', '場所3': '11F|12F|13F|14F|15F'},
    '日比谷 東京ミッドタウン日比谷': {'場所1': 'ミッドタウン日比谷', '場所2': '', '場所3': ''},
    '日比谷 OKUROJI': {'場所1': '内幸町1-7-1', '場所2': '', '場所3': ''},
    '銀座 東急プラザ': {'場所1': '銀座5-2-1', '場所2': '', '場所3': ''},
    '銀座 GINZA SIX': {'場所1': '銀座6-10-1', '場所2': '', '場所3': ''},
    '大手町 TOKYO TORCH 常盤橋タワー': {'場所1': '大手町2-6-4', '場所2': '', '場所3': ''},
    '丸の内 丸の内ビルディング': {'場所1': '丸の内2-4-1', '場所2': '', '場所3': ''},
    '丸の内 新丸の内ビルディング': {'場所1': '丸の内1-5-1', '場所2': '', '場所3': ''},
    '四谷 コモレ四谷': {'場所1': '新宿区四谷1-6-1', '場所2': '', '場所3': ''},
    '豊洲 ららぽーと豊洲': {'場所1': '豊洲', '場所2': '2-4-9|2-2-1', '場所3': ''},
    '有明ガーデン': {'場所1': '有明2-1-8', '場所2': '', '場所3': ''},
    'ラクーア': {'場所1': '春日1-1-1', '場所2': '', '場所3': ''},
}
