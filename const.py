...
# DataFrameレイアウト
DATA_FLAME_LAYOUT = {
    'No': [40, tk.E], '全国順位': [60, tk.E], '順位変動_str': [70, tk.E], '店名': [300, tk.W], 'ステータス': [80, tk.W], '点数_str': [60, tk.E], '点数(増減)_str': [60, tk.E], 
    '口コミ数': [80, tk.E], '口コミ数(増減)_str': [80, tk.E], '保存件数': [90, tk.E], '予算(夜)': [150, tk.E], '予算(昼)': [150, tk.E], 
...
# 営業状況
BUSINESS_STATUS_LIST = ['標準', '新規オープンのみ', '昨年閉店のみ', '過去店全表示']
