...
# DataFrameレイアウト
DATA_FLAME_LAYOUT = {
    'No': [40, tk.E], '全国順位': [60, tk.E], '順位変動_str': [70, tk.E], '都道府県': [80, tk.W], '店名': [300, tk.W], 'ステータス': [80, tk.W], '点数_str': [60, tk.E], '点数(増減)_str': [60, tk.E], 
...
SHISETSU_DICT = {
    ...
    '渋谷区 渋谷スクランブルスクエア': {'都道府県': '東京都', '場所1': '渋谷2-24-12|渋谷スクランブルスクエア', '場所2': '12F|13F', '場所3': ''},
