...
# DataFrameレイアウト
DATA_FLAME_LAYOUT = {
    'No': [40, tk.E], '全国順位': [60, tk.E], '順位変動_str': [70, tk.E], '都道府県': [80, tk.W], '店名': [440, tk.W], 'ステータス': [80, tk.W], '点数_str': [60, tk.E], '点数(昨年)_str': [60, tk.E], '点数(一昨年)_str': [60, tk.E],  '点数(3年前)_str': [60, tk.E], 
    '口コミ数': [60, tk.E], '口コミ数(増減)_str': [60, tk.E], '口コミ数(増減2)_str': [60, tk.E], '口コミ数(増減3)_str': [60, tk.E], '保存件数': [90, tk.E], '予算(夜)': [150, tk.E], '予算(昼)': [150, tk.E], 
    '食べログアワード': [200, tk.W], '百名店': [180, tk.W], 'ジャンル1': [130, tk.W], 'ジャンル2': [130, tk.W], 'ジャンル3': [130, tk.W], 
    '所在地': [200, tk.W], '施設名': [240, tk.W], '最寄り駅': [100, tk.W], '席数': [70, tk.E], 'オープン日': [130, tk.E], '説明詳細': [500, tk.W]
}

# DF全カラムヘッダー
MERGE_COL_NAMES = [
    'ID', 'URL', '取得日時', '都道府県', '所在地', '施設名', '最寄り駅', 'ステータス', '店名', '店名(補足)', '食べログアワード',
...
SHISETSU_DICT = {
    ...
    '北海道 トナリエ北広島': {'都道府県': '北海道', '場所1': '北広島市栄町1-52|トナリエ北広島', '場所2': '', '場所3': ''},
    ...
    '港区 BLUE FRONT SHIBAURA': {'都道府県': '東京都', '場所1': '港区芝浦1-1-1|BLUE FRONT SHIBAURA', '場所2': '', '場所3': ''},
    '港区 NEWoMan高輪': {'都道府県': '東京都', '場所1': '港区高輪2-21-1|港区高輪2-21-2|ニュウマン高輪|NEWoMan高輪', '場所2': '', '場所3': ''},
    ...
    '文京区 メトロ・エム 後楽園': {'都道府県': '東京都', '場所1': '文京区春日1-2-3', '場所2': '', '場所3': ''},
    ...
    '品川区 大井町トラックス': {'都道府県': '東京都', '場所1': '品川区広町2-1|OIMACHI TRACKS', '場所2': '', '場所3': ''},
    '目黒区 自由が丘 デュ アオーネ': {'都道府県': '東京都', '場所1': '自由が丘2-15-4|de aone', '場所2': '', '場所3': ''},
    ...
    '渋谷区 渋谷アクシュ': {'都道府県': '東京都', '場所1': '渋谷2-17-1|渋谷アクシュ', '場所2': '', '場所3': ''},
    '渋谷区 渋谷サクラステージ': {'都道府県': '東京都', '場所1': 'サクラステージ|sakura stage|桜丘町1-1|桜丘町1-4', '場所2': '', '場所3': ''},
    ...
    '豊島区 ルミネ池袋': {'都道府県': '東京都', '場所1': '西池袋1-11-1|ルミネ池袋', '場所2': '', '場所3': ''},
    '豊島区 東武百貨店 スパイス': {'都道府県': '東京都', '場所1': '池袋', '場所2': '東武百貨店', '場所3': '11F|12F|13F|14F|15F'},
    '豊島区 ヨドバシHD池袋ビル': {'都道府県': '東京都', '場所1': '南池袋1-28-1|ヨドバシHD池袋ビル', '場所2': '8F|9F', '場所3': ''},
    ...
    '足立区 ららテラス北綾瀬': {'都道府県': '東京都', '場所1': '谷中4-8-1|ららテラス北綾瀬', '場所2': '', '場所3': ''},
    ...
    '葛飾区 MARK IS 葛飾かなまち': {'都道府県': '東京都', '場所1': '東金町1-10-1$|MARK IS 葛飾かなまち', '場所2': '', '場所3': ''},
    ...
    '埼玉県草加市 TOBU icourt ': {'都道府県': '埼玉県', '場所1': 'icourt|草加市松原3-3-1|草加市松原3-1638-11', '場所2': '', '場所3': ''},
...
THEME_DICT = {
    ...
    Rojiura Curry SAMURAI． 神楽坂店|CHUTTA！ 新潟駅南店|タイガーカレー 新潟店|スープカリー ばぐばぐ 仙台店|KINO_|SOUP CURRY KING FCじぞう通り店"""},
}
